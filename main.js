...
const posts = [
    {
        id: 1,
        content: "va bene ragazzi Clap Clap Clap è il momento gaming, si peepoJAMMER è il momento gaming, si peepoJAMMER videogiochi per ogni gusto peepoJAMMER per ogni età e per ogni lustro peepoJAMMER videogiochi, vi-videogiochi peepoJAMMER vi-videogiochi, tanti videogames peepoJAMMER su cui ridere, piangere, avventurarsi in misteriosi mondi videoludici, videogaaaames",
...
//Variabile per i contenitore
const feed = document.getElementById('container');

function createFeed(i){
    feed.innerHTML += `
    <div class="post">
            <div class="post__header">
                <div class="post-meta">                    
                    <div class="post-meta__icon">
                        <img class="profile-pic" src="${posts[i].author.image}" alt="${posts[i].author.name.charAt(0)}">                    
                    </div>
